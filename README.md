![Simone Kettle Francis — Better questions. More trustworthy answers.](docs/assets/hero.svg)
...
<td width="50%" valign="top"><a href="docs/studies/response-evaluation.md"><img src="docs/assets/response-evaluation.svg" alt="Response evaluation workflow" width="100%"></a><h3>02 · Response evaluation</h3><p>Use a small, original rubric to distinguish factual support, instruction following, and clarity.</p><a href="docs/studies/response-evaluation.md">Read the demonstration →</a></td>
</tr></table>

<table><tr>
<td width="50%" valign="top"><a href="docs/studies/failure-analysis.md"><img src="docs/assets/failure-analysis.svg" alt="Failure analysis workflow" width="100%"></a><h3>03 · Failure analysis</h3><p>Separate an unsupported inference from a formatting error, then define a focused regression check.</p><a href="docs/studies/failure-analysis.md">Read the demonstration →</a></td>
<td width="50%" valign="top"><a href="docs/studies/tool-use.md"><img src="docs/assets/tool-use.svg" alt="Tool-use evaluation workflow" width="100%"></a><h3>04 · Tool-use evaluation</h3><p>Evaluate a fictional travel search against budget, timing, and explicit missing information.</p><a href="docs/studies/tool-use.md">Read the demonstration →</a></td>
</tr></table>

<table><tr>
<td width="50%" valign="top"><a href="docs/studies/image-understanding.md"><img src="docs/assets/image-understanding.svg" alt="Image understanding workflow" width="100%"></a><h3>05 · Image understanding</h3><p>Use an original chart to separate correct extraction from an unsupported causal explanation.</p><a href="docs/studies/image-understanding.md">Read the demonstration →</a></td>
